...
?></p></center>
    ...
    <form method="post" action="">
      ...
      <input type="text" name="whichbatch">
      <input type="submit" name="batch" value="Show!" >
    </form>
